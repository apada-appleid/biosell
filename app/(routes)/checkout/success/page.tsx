...
const CheckoutSuccessContent = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 text-center min-h-[calc(100vh-56px)] bg-white">
        ...
        <svg className="absolute top-0 left-0 w-24 h-24" viewBox="0 0 100 100">
          <circle
            className={`text-green-500 ${
              animationComplete ? "animate-circle-completion" : ""
            }`}
            stroke="currentColor"
            strokeWidth="5"
            fill="transparent"
      ...
      >
        سفارش شما با موفقیت ثبت شد. اطلاعات سفارش و روند ارسال از طریق پیامک به
      ...
      <div
        className={`mt-8 p-4 bg-gray-50 rounded-lg w-full max-w-sm border border-gray-200 
      ...
      >
        ...
        <div className="flex justify-between items-center mb-2">
          ...
          <div className="flex items-center">
            <p className="text-sm text-gray-900 font-medium ml-1 dir-ltr">
              {orderNumber}
            </p>
            <button
